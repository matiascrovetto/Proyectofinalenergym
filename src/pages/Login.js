    ...
    <div className="container">
      <div className="row">
        <div className="col-md-12">
          {error && <Alert color="danger" text={error.msg} className="" />}
          <form className="form w-50 mx-auto bg-warning shadow my-5 p-2" onSubmit={handleLogin}>
